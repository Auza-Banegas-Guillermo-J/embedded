...
int main(void) {
    ...
    while (1){
        if(flag){
            ...
            for(uint32_t i=240000; i>120000; i-=10){
...
void ConfigurePWM(uint32_t pwmGen, uint32_t pwmOutBit, uint32_t gpioBase, uint32_t gpioPin, uint32_t gpioPinConfig, uint32_t targetPeriod){
